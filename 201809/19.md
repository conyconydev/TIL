...
![스크린샷 2018-09-18 오후 11.18.56](/Users/adolph/Desktop/스크린샷 2018-09-18 오후 11.18.56.png)
...
class Parent {
	...
	required convenience init() { 			self.init(a : 0)
	}	 
}
```
...
class Child : Parent {
	...
	required convenience init() { 			self.init(a : 0, b : 0)
	} 
}
```
